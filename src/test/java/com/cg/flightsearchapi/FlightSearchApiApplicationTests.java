...
class FlightSearchApiApplicationTests {
	...
	public void getAllFlightsTest() {
		...
		when(repository.findAll())
				.thenReturn((List<Flights>) Stream
						.of(new Flights("1", "GOAIR A36", "BBS", "MUM", "03-02-2021", 6000),
								new Flights("3", "INDIGO B415", "KOL", "BLR", "15-01-201", 7000))
						.collect(Collectors.toList()));

		assertEquals(2, service.viewFlights().size());

	}

	@Test
	public void getFlightBySourceDestinationDateTest() {
		when(repository.findBySourceDestinationDate("BBS", "MUM", "03-02-2021")).thenReturn((List<Flights>) Stream
				.of(new Flights("1", "GOAIR A36", "BBS", "MUM", "03-02-2021", 6000)).collect(Collectors.toList()));
	...
	public void addFlightTest() throws Exception {
		Flights flight = new Flights("99", "GOAIR 999", "BBS", "BLR", "03-02-2021", 4000);
